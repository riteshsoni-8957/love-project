      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .lp-btn-yes {
          ...
          padding: 8px 9px;
          font-size: clamp(13px, 2.2vw, 10px);
        }
      ...
      <div className="lp-card">
        ...
        {isQuestionStep && (
          <>
            ...
            {/* <div className="lp-eyebrow">Bas 4 sawaal</div> */}
            <div style={{ fontWeight : "bold"}} className="lp-question-text">{CONFIG.questions[step].text}</div>
            <div style={{ fontWeight : "bold"}} className="lp-question-sub">{CONFIG.questions[step].sub}</div>
        ...
        {isProposalStep && (
          <div className="lp-stage" ref={stageRef}>
            <div className="lp-stage-inner">
              <div style={{fontWeight:"bold"}} className="lp-signature-line">Tumhare liye,</div>
              ...
              <div style={{fontWeight:"bold"}} className="lp-subline" style={{ marginTop: 6 }}>{CONFIG.finalQuestion}</div>
